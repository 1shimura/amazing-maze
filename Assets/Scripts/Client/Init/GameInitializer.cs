...
namespace Client.Init
{
    public class GameInitializer : MonoBehaviour
    {
        ...
        public void Start()
        {
            _gameManager.Initialize(_gameSettingsManager, _virtualCamera);
        ...
        private void InitializeUI(GameConfig gameConfig)
        {
            ...
            new UISettingsScreenController(_settingsScreenView, _gameManager, _firstSceneIndex);
            new UITimerController(gameConfig, _timerView, _gameManager);
            new UIRestartScreenController(_restartScreenView, _gameManager, _firstSceneIndex);
        }
    }
}